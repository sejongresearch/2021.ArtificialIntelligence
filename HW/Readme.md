...
- 제출자료: 노트북 파일 (.ipynb) 공유 (담당조교계정: kjwdubu, sjmin99) 
- 제출: 캐글 리더보드
...
- 답안제출: 캐글 리더보드
- 제출자료: 캐글 노트북 파일 (.ipynb) **공유** (담당조교계정: juyounghong, yujinhwang) 
  -  [주의] 캐글 노트북 파일은 리더보드 제출 성능 기록이 함께 남아 있는 파일이어야 합니다. 
- 담당조교: 홍주영TA, 황유진TA
...
- 제출자료: 노트북 파일 (.ipynb) 공유 (담당조교계정: daechanhan, hyeongjun0117) 
- 제출: 캐글 리더보드
...
- 제출자료: 노트북 파일 (.ipynb) 공유 (담당조교계정: kjwdubu, xown3197) 
- 제출: 캐글 리더보드
