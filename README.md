...
- 가상 학번 제도 도입하여 리더보드 제출 시 실명에 대한 부담을 줄여주고자 함
  - 리더보드를 통해 베이스라인 제출 등의 과정을 public으로 운영하는 이유는 학생 각자 자신의 실력을 포지셔닝 하길 바래서임 
...
| 9 | 합성곱신경망 I (이론) |  | 2021.10.25 | [Youtube](https://youtu.be/Tqt_T6OpvEo) | 텀프 제안서 마감: 10/24 <br> [텀프](https://github.com/sejongresearch/ArtificialIntelligence/blob/main/HW/Readme.md) | 
